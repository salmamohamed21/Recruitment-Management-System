...
GEMINI_API_KEY = "AIzaSyCwq7kSKnqTe66jr27-U-0x_TgstrDuT8c"
# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-d#$u58x)xyh_=c2!sr)j76cof5fywzx0yuayse2p3&b4ue8c1k'
...
INSTALLED_APPS = [
    ...
    'api',
    'rest_framework',
    'rest_framework.authtoken',  # إضافة دعم التوكن
    'corsheaders',
    'django_filters',
]
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # أضف هذا هنا
...
# JWT Settings - Increase token lifetimes (optional)
from datetime import timedelta
